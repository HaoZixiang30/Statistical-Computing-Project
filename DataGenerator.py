...
Desc: Generating data for simulation
'''
...
class DataGenerator:
    ...
    def __call__(self, K, n_list, func_name, delta, lambdaa):
        return self.forward(K, n_list, func_name, delta, lambdaa)
    ...
    def forward(self, K, n_list, func_name, delta=0, lambdaa=1):# eg: K 1000 n_list:[100, 150, 200, 300, 400, 500]
        '''
        @Params: 
        ...
        for i in range(K):
            ...
            for n in n_list:
                ...
                random_x = self.inverse_func(random_y, func_name, delta, lambdaa)
...
if __name__ == '__main__':
    ...
    samples = datagenerator(K, n_list, 'UExE', delta=0.5, lambdaa=0.5)
    print(samples[1][500])